...
$sBSAPIMissing='You need to enter your <a class="menu" href="http://botscout.com">BotScout API Key</a> key before I query their database (see config.php)';
$sSFSAPIMissing='You need to enter your <a class="menu" href="http://stopforumspam.com">StopForumSpam API Key</a> key before I query their database (see config.php)';
$sFSLAPIError='fSpamlist API Key missing';
$sSFSAPIError='StopForumSpam API Key missing';
$sPHPAPIError='ProjectHoneyPot API Key missing';
$sBSAPIError='BotScout API Key missing';
