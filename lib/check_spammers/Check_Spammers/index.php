	...
	<td align="center" valign="top" class="content">
		<?php
			...
			if($p_type ==''){
				...
				// Ensure the StopForumSpam API key is here
				if($sSFSAPI ==''){
					echo '<span class="error">'.$sSFSAPIMissing.'</span><br><br>';
				}
		...
		?>
					<form method="GET" name="checkspamdb" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
...
<tr>
		...
		<a class="footer" href="<?php echo $_SERVER["PHP_SELF"]; ?>?p=History">Version History</a> 
		<?php
			echo ' | ';
		...
		<br><br>
		<a rel="license" class="footer" href="http://opensource.org/licenses/MIT">http://opensource.org/licenses/MIT</a><br><span xmlns:dc="http://purl.org/dc/elements/1.1/" property="dc:title">Spambot Search Tool</span> by <a class="footer" href="http://support.it-mate.co.uk/?mode=Products&amp;p=spambotsearchtool">Steven Burn</a>, <a class="footer" xmlns:dc="http://purl.org/dc/elements/1.1/" href="http://guildwarsholland.nl/phphulp/testspambot.php" rel="dc:source">Smurf Minions</a> is licensed under a <a class="footer" rel="license" href="http://opensource.org/licenses/MIT">The MIT License</a>.<br>Based on a work at <a class="footer" xmlns:dc="http://purl.org/dc/elements/1.1/" href="http://guildwarsholland.nl/phphulp/testspambot.php" rel="dc:source">guildwarsholland.nl</a> with bug fixes courtesy of <a class="footer" xmlns:dc="http://purl.org/dc/elements/1.1/" href="http://www.cedit.biz/joomla-extensions/18-registration-validator/22-block-disposable-email-addresses" rel="dc:source">Dan McCormick</a>.<br>Permissions beyond the scope of this license may be available at <a class="footer" href="http://mysteryfcm.co.uk/?mode=Contact">http://mysteryfcm.co.uk/?mode=Contact</a>.
	</td>
</tr>
</table>
</body>
